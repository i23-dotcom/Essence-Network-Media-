...
## V6.2.2 Production Studio
- Production Desk dashboard with live channel, source, audio, graphics and playout status.
- Quick TAKE controls for scheduled broadcast items.
- Studio now loads the active studio JavaScript/CSS bundle rather than the stale V5 bundle.
- Responsive, operator-friendly control layout.
